...
class SignalGenerator {
  const SignalGenerator._(); // static-only utility
  ...
  // =============================
  static Float32List whiteNoise(int n, {double amplitude = 1.0, int? seed}) {
  ...
  // =============================
  static Float32List linearSweep({
    required int n,
  ...
  // =============================
  static Float32List exponentialSweep({
    required int n,
    required double fStart,
    required double fEnd,
    required double sampleRate,
  ...
  // =============================
  static Float32List arange(num startOrStop, [num? stop, num step = 1]) {
